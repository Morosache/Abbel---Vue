...
import carousel1 from '/src/images/carousell1.jpg'
import carousel2 from '/src/images/carousell2.jpg'
import carousel3 from '/src/images/carousell3.jpg'
...
<template>
    <div class="h-[70vh]">
        ...
        <div class="fixed z-50 w-screen h-[65px] bg-[#ffffff]/[10%] flex flex-row justify-between items-center">
            <img src="/src/images/logo.png" alt="logo" class="w-[70px] h-[60px] opacity-[100%] mx-[15px]"></img>
